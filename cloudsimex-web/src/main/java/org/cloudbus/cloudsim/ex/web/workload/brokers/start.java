...
public class start {
	...
	public static void main(String[] args) throws SecurityException, IOException{
        ...
        try {
            ...
            //MonitoringBorkerEX broker = new MonitoringBorkerEX("test", 10, 1, 1);
            ...
            // create two VMs
            ArrayList<HddVm> lst = new ArrayList<>();
            for (int i = 0; i < 3; i++) {
                ...
                //appServerVM.updatePerformance(Math.random(), 0.5, 0.7);
                lst.add(appServerVM);
            ...
            int appID = 32;          
            ILoadBalancer balancer = new SimpleWebLoadBalancer(appID, "127.0.0.1", lst,
	...
	private static Datacenter createDatacenter(final String name) {
	   ...
	   private static void printCloudletList(final List<Cloudlet> list) {
	        ...
	        for (int i = 0; i < size; i++) {
	            ...
	            //System.out.println(TextUtil.getTxtLine(cloudlet));
	        }
	    }
